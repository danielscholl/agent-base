...
[Brief usage examples - link to USAGE.md for details]
...
- Links to detailed documentation (USAGE.md, CONTRIBUTING.md)
...
ls -la README.md USAGE.md CONTRIBUTING.md LICENSE
```
...
1. Create `README.md` with:
   ...
   - Usage examples
   - Links to USAGE.md and CONTRIBUTING.md
   - License information
...
grep -r "USAGE.md\|CONTRIBUTING.md" README.md
...
- README links to USAGE.md and CONTRIBUTING.md
...
- [ ] README, USAGE.md, and CONTRIBUTING.md created
